...
enum SocketColor
{
	...
	SOCKET_COLOR_RELIC_IRON						= 64,
	SOCKET_COLOR_RELIC_BLOOD					= 128,
	SOCKET_COLOR_RELIC_SHADOW					= 256,
	SOCKET_COLOR_RELIC_FEL						= 512,
	SOCKET_COLOR_RELIC_ARCANE					= 1024,
	SOCKET_COLOR_RELIC_FROST					= 2048,
	SOCKET_COLOR_RELIC_FIRE						= 4096,
	SOCKET_COLOR_RELIC_WATER					= 8192,
	SOCKET_COLOR_RELIC_LIFE						= 16384,
	SOCKET_COLOR_RELIC_WIND						= 32768,
	SOCKET_COLOR_RELIC_HOLY						= 65536
};

#define SOCKET_COLOR_ALL (SOCKET_COLOR_META | SOCKET_COLOR_RED | SOCKET_COLOR_YELLOW | SOCKET_COLOR_BLUE | SOCKET_COLOR_COGWHEEL| SOCKET_COLOR_HYDRAULIC)
...
#define MAX_ITEM_SUBCLASS_GENERIC                 2
...
enum ItemSubclassPermanent
{
	...
	ITEM_SUBCLASS_UNK1							= 12
};

#define MAX_ITEM_SUBCLASS_PERMANENT               13
