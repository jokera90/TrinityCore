...
{
    uint32      ID;                                         // 0        m_ID
	char*   modelname[2];                                   // 1        m_modelName[2]
	char*   modeltexture[2];                                // 2        m_modelTexture[2]
	char*   inventoryIcon[2];                               // 3        m_inventoryIcon
	//uint32  geosetgroup[3];                                 // 4        m_geosetGroup[3]
	//uint32  flags;                                          // 5        m_flags
	//uint32  spellvisual;                                    // 6        m_spellVisualID
	//uint32  groupsound;                                     // 7        m_groupSoundIndex
	//uint32  helmgeoset[2];                                  // 8        m_helmetGeosetVis[2]
	//char*   texture[8];                                     // 9        m_texture[2]
    //uint32  itemvisual;                                     // 10       m_itemVisual[8]
	//uint32  particlecolor;                                  // 11       m_particleColorID
};
