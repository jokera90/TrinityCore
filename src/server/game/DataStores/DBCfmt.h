...
char const CreatureDisplayInfoExtrafmt[] = "niiiiiiiiiiiiiiiiiixs";
...
//char const ItemDisplayTemplateEntryfmt[] = "nssssssiiiiiiiissssssssii";
char const ItemDisplayTemplateEntryfmt[] = "nssssssxxxxxxxxxxxxxxxxxx";
