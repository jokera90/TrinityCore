        ...
        else
        {
            ...
            do
            {
                ...
                if (!data)
                {
					...
					TC_LOG_ERROR("sql.sql", "DELETE FROM pool_creature WHERE guid = %u and pool_entry = %u;", guid, pool_id);
        ...
        else
        {
            ...
            do
            {
                ...
                if (!data)
                {
					...
					TC_LOG_ERROR("sql.sql", "DELETE FROM pool_gameobject WHERE guid =%u and pool_entry =%u;", guid, pool_id);
                    continue;
                }
