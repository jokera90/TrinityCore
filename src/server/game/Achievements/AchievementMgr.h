...
{                                                           // value1         value2        comment
	...
	ACHIEVEMENT_CRITERIA_DATA_TYPE_UNKNOWN             = 26,
	ACHIEVEMENT_CRITERIA_DATA_TYPE_UNKNOWN2            = 27,
	ACHIEVEMENT_CRITERIA_DATA_TYPE_UNKNOWN3   		   = 28,
	ACHIEVEMENT_CRITERIA_DATA_TYPE_UNKNOWN4            = 29
};
